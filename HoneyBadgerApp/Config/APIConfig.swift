...
struct HoneyBadgerAPIConfig {
    ...
    struct Endpoints {
        ...
        // Gift action endpoints
        static func unlockGift(id: String) -> String {
            return "/api/gifts/\(id)/unlock"
        }

        static func nudgeGift(id: String) -> String {
            return "/api/gifts/\(id)/nudge"
        }

        static func recipientUnlockGift(id: String) -> String {
            return "/api/gifts/\(id)/recipient-unlock"
        }

        static func collectGift(id: String) -> String {
